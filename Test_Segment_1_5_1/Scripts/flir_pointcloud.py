...
class ImageSubscriber(Node):
    ...
    def create_points_from_mask(self, mask, y_offset):
        ...
        #y_indices += y_offset  # Add the offset to the y-coordinates
        #z_indices = np.zeros_like(x_indices) + 2  # Place the point cloud 2 meters ahead
        y_indices, x_indices = np.where(mask)
